...
function SearchResults({ results }) {
  return (
    <div className="mx-auto mt-10 max-md:w-full max-w-3xl max-md:px-3">
      <p className="text-secondary-400 text-center text-[.75rem] mb-6"> About {results.searchInformation?.formattedTotalResults} results ({results.searchInformation?.formattedSearchTime} seconds) </p>
